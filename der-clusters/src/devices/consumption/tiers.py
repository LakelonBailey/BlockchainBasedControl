...
class LowPowerTier(ConsumptionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=20, tier_no=2)
...
class MediumPowerTier(ConsumptionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=30, tier_no=3)
...
class HighPowerTier(ConsumptionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=40, tier_no=4)
...
class HigherPowerTier(ConsumptionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=50, tier_no=5)
