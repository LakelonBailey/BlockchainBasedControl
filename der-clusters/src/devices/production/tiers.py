...
class LowProductionTier(ProductionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=1.0, tier_no=1)
...
class ModerateProductionTier(ProductionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=2.0, tier_no=2)
...
class HighProductionTier(ProductionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=3.0, tier_no=3)
...
class VeryHighProductionTier(ProductionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=4.0, tier_no=4)
...
class ExtremeProductionTier(ProductionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=5.0, tier_no=5)
