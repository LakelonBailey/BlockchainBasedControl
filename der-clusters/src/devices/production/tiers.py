...
class ModerateProductionTier(ProductionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=50.0, tier_no=2)
...
class HighProductionTier(ProductionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=100.0, tier_no=3)
...
class VeryHighProductionTier(ProductionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=500.0, tier_no=4)
...
class ExtremeProductionTier(ProductionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=1000.0, tier_no=5)
