from src.lib.consumption.base import ConsumptionTier
...
class LowerPowerTier(ConsumptionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=0.05, tier_no=1)
...
class LowPowerTier(ConsumptionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=0.2, tier_no=2)
...
class MediumPowerTier(ConsumptionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=1.5, tier_no=3)
...
class HighPowerTier(ConsumptionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=3.5, tier_no=4)
...
class HigherPowerTier(ConsumptionTier):
    ...
    def __init__(self):
        super().__init__(default_kw=7.0, tier_no=5)
